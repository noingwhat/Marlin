...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {500*60, 500*60, 80*60, 500*60} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_LOAD_FEEDRATE 70    // (mm/s) Load filament feedrate. This can be pretty fast.
